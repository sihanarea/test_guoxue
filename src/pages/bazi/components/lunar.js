  ...
  var Tao = (function () {
    ...
    var _fromLunar = function (lunar) {
      return {
        ...
        toFullString: function () {
          return '道历' + this.getYearInChinese() + '年，天运' + this._p.lunar.getYearInGanZhi() + '年，' + this._p.lunar.getMonthInGanZhi() + '月，' + this._p.lunar.getDayInGanZhi() + '日。' + this.getMonthInChinese() + '月' + this.getDayInChinese() + '日，' + this._p.lunar.getTimeZhi() + '时。';
        }
      };
    };
    return {
